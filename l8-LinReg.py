...
strat_train_set_labels = strat_train_set["median_house_value"].copy() #moving a copy of lables from housing dataset to strat_train_set_labels
strat_train_set = strat_train_set.drop("median_house_value", axis=1) #moving a copy of attributes from housing dataset to strat_train_set
...
print("label value for top 5 value",strat_test_set_labels[:5])
